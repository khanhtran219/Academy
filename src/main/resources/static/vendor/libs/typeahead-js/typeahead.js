                                        ...
                                        n.mixin(u.prototype, {
                                            ...
                                            _get: function(e, n) {
                                                ...
                                                this.cancelled || s !== this.lastReq || ((o = i[s]) ? o.done(a).fail(c) : t < r ? (t++,
                                                    i[s] = this._send(e).done(a).fail(c).always(h)) : this.onDeckRequestArgs = [].slice.call(arguments, 0))
                                            },
                                            get: function(t, i) {
                                                var r, s;
                                                i = i || e.noop,
                                        ...
                                        o = {
                                            initialize: function(t, o) {
                                                ...
                                                function g() {
                                                    ...
                                                    m && m.val(""),
                                                        i = d(i, a),
                                                    (v || _) && (g.css(a.css.wrapper),
                                                        i.css(v ? a.css.input : a.css.inputWithNoHint),
                                                        i.wrap(g).parent().prepend(v ? m : null).append(_ ? y : null)),
                                                        A = _ ? h : c,
                                                        b = new r({
                                                            el: i
                                                        }),
